...
+ [x] 接收所有消息、下载图片、cdn下载、发送文字消息、发送文件消息、发送图片消息、发送语音消息、发送视频消息
+ [x] 发送链接消息、发送名片消息、发送各类app消息、发送小程序消息、转发文件、转发图片、转发视频、转发链接
+ [x] 获取登录二维码、执行登录、获取通讯录列表、获取通讯录列表缓存、获取群/好友简要信息、获取群/好友详细信息
+ [x] 搜索好友、 添加联系人、同意添加好友、删除好友、设置好友仅聊天、设置好友备注
+ [x] 获取手机通讯录、上传手机通讯录、同步企微好友、获取企微好友详情、修改头像、同步收藏夹、获取收藏夹内容
+ [x] 创建微信群、修改群名称、修改群备注、修改我在群内的昵称、邀请/添加入群、删除群成员、退出群聊、解散群聊
+ [x] 获取群信息、获取群成员列表、获取群成员详情、获取群公告、设置群公告、同意进群、 添加群成员为好友
+ [x] 获取群二维码、群保存到通讯录、管理员操作、聊天置顶、设置消息免打扰、扫码进群、 确认进群申请
+ [x] 转发小程序、撤回消息、添加标签、修改好友标签、获取个人资料、获取自己的二维码、隐私设置、修改个人信息
